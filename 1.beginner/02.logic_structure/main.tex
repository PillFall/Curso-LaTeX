...
\begin{description}
    \item[Corchetes] \mintinline{latex}{{ <ámbito> }}
    \item[Grupos] \mintinline{latex}{\begingroup <ámbito> \endgroup}
    \item[Entornos] \mintinline{latex}{\begin{environment} <ámbito> \end{environment}}
\end{description}
\end{frame}
...
\begin{minted}{latex}
\multicolumn{<columnas>}{<formato>}{<texto>}
\end{minted}
\end{frame}
...
\begin{minted}{latex}
\multirow[<vpos>]{<filas>}{<ancho>}{<text>}
\end{minted}
