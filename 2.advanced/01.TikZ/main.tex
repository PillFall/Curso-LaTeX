...
Para TikZ, el primer argumento es el \alert{ángulo} y el segundo el \alert{radio}.
        ...
        \begin{block}{}
            \begin{onlyenv}<1>
                \begin{tikzpicture}
                    ...
                    \draw (0,0) node {};
                    \draw (2,0) node {};
                    \draw (0,2) node [circle] {};
                    \draw (2,2) node [circle] {};
                \end{tikzpicture}
            \end{onlyenv}
            \begin{onlyenv}<2->
                \begin{tikzpicture}
                    ...
                    \draw[dashed, help lines] (0,0) node [fill] {} -- (0,2) node [fill, circle] {};
                    \draw[dashed, help lines] (2,0) node [fill] {} -- (2,2) node [fill, circle] {};
                \end{tikzpicture}
            \end{onlyenv}
        \end{block}
    \end{column}
    ...
    \begin{column}{0.45\textwidth}
        \begin{block}{}
            ...
            \begin{onlyenv}<2->
                \begin{tikzpicture}
                    \useasboundingbox (0,0) circle (2 and 1);
                    \draw[dashed,help lines] (0,0) circle (2 and 1);
                    \draw (10:2 and 1) arc (10:130:2 and 1);
                \end{tikzpicture}
            \end{onlyenv}
        \end{block}
...
\begin{tikzpicture}[draw,node distance=1cm]
    ...
    \node (process)
        [below right of=check,node distance=2cm] {Procesar};
