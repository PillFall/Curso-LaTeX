...
\begin{itemize}
	\item \lstinline[language={[LaTeX]TeX}]|\title{<título>}|
	\item \lstinline[language={[LaTeX]TeX}]|\author{<autor o autores>}|
	\item \lstinline[language={[LaTeX]TeX}]|\date{<fecha>}|
\end{itemize}\pause\vspace{2em}

Y para colocarlos en el documento de forma general, podemos hacerlo mediante la orden \lstinline[language={[LaTeX]TeX}]|\maketitle|
\end{frame}

\begin{frame}[fragile]{Títulos}{}
Al escribir esto ya en un documento, de manera normal, podemos obtener esto.\\[1em]
...
Al escribir cualquier tipo de documento siempre es bueno llevar una estructura e intentar no romperla a lo largo de este.
\end{frame}
