...
$NotoFonts = @(
    ...
    @{ filename = "Noto_Emoji/NotoEmoji-VariableFont_wght.ttf"; path = "$FontFolder\NotoEmoji.ttf" },
    @{ filename = "Material_Symbols_Outlined/MaterialSymbolsOutlined-VariableFont_FILL,GRAD,opsz,wght.ttf"; path = "$FontFolder\MaterialSymbolsOutlined.ttf" },
    @{ filename = "Material_Symbols_Rounded/MaterialSymbolsRounded-VariableFont_FILL,GRAD,opsz,wght.ttf"; path = "$FontFolder\MaterialSymbolsRounded.ttf" },
    @{ filename = "Material_Symbols_Sharp/MaterialSymbolsSharp-VariableFont_FILL,GRAD,opsz,wght.ttf"; path = "$FontFolder\MaterialSymbolsSharp.ttf" }
)
