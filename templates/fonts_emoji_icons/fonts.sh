...
MANIFEST=$(curl -GsL "https://fonts.google.com/download/list" --data-urlencode "family=Noto Sans,Noto Sans Math,Noto Emoji,Noto Color Emoji,Material Symbols Outlined,Material Symbols Rounded,Material Symbols Sharp")
MANIFEST="{${MANIFEST#*{}"
...
Noto_Color_Emoji/NotoColorEmoji-Regular.ttf|NotoColorEmoji.ttf
